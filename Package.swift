...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "VoximplantSDK", url: "https://voximplant-releases.s3.eu-central-1.amazonaws.com/ios-sdk/2.46.6/VoximplantSDK.zip", checksum: "87c9976113a5f274642c0632eab5dd1699fb01549dca482a06056de2e08256e4"),
